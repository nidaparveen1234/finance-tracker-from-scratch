...
while(True): 
    ...
    choices = input("Menu ----do you want to continue : say yes  -- if you want to edit :say 1 --if you want to delete say 2 :-- and enter exit to finish")
    match choices:
        case"yes": 
            add_item_to_dict()
...
# Menu ----do you want to continue : say yes  -- if you want to edit :say 1 --if you want to delete say 2 :-- and enter exit to finishyes
...
# Enter the expense20
# Enter the categorydogsd
# Enter the date2-2
# Menu ----do you want to continue : say yes  -- if you want to edit :say 1 --if you want to delete say 2 :-- and enter exit to finish2
# enter the serial number to delete2
# {1: {'Expense': 20, 'Category': 'food', 'Date': '12-3'}}
# Menu ----do you want to continue : say yes  -- if you want to edit :say 1 --if you want to delete say 2 :-- and enter exit to finishexit
